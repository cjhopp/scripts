...
#SBATCH --output=matchout_%a_stack.txt
#SBATCH --error=matcherr_%a_stack.txt
...
srun python2.7 /projects/nesi00228/scripts/6_PAN_match_filt_stack.py --splits 183 --instance $SLURM_ARRAY_TASK_ID
