...
SIG08a = SIG08a - [2.05 1.33 -0.01]
%SIG08b = SIG08b - [2.05 1.33 -0.01]
plot3([SIG08a(1),SIG08b(1)],[SIG08a(2),SIG08b(2)],[SIG08a(3),SIG08b(3)],'k--', 'LineWidth', 2);
...
% [xl8,yl8,zl8] = twoPntArraySpec(SIG08a,SIG08b,30,8,3);
% [xl9,yl9,zl9] = twoPntArraySpec(SIG09a,SIG09b,40,4,6);
% plot3(xl8,yl8,zl8,'r*', 'LineWidth', 2, 'MarkerSize', 20);
% plot3(xl9,yl9,zl9,'r*', 'LineWidth', 2, 'MarkerSize', 20);
%twoPntArraySpec(loc1, loc2, wlDepth, elNum, delta)
[xl8,yl8,zl8] = twoPntArraySpec(SIG08a,SIG08b,35,3,4);
[xl8b,yl8b,zl8b] = twoPntArraySpec(SIG08a,SIG08b,36,3,4);
[xl9,yl9,zl9] = twoPntArraySpec(SIG09a,SIG09b,45,3,4);
[xl9b,yl9b,zl9b] = twoPntArraySpec(SIG09a,SIG09b,46,3,4);
plot3(xl8,yl8,zl8,'r*', 'LineWidth', 2, 'MarkerSize', 20);
plot3(xl9,yl9,zl9,'r*', 'LineWidth', 2, 'MarkerSize', 20);
plot3(xl8b,yl8b,zl8b,'r*', 'LineWidth', 2, 'MarkerSize', 20);
plot3(xl9b,yl9b,zl9b,'r*', 'LineWidth', 2, 'MarkerSize', 20);
xlabel('Easting (m)');
ylabel('Northing (m)');
zlabel('Elevation (m)');
...
legend('B1 SIMFIP','B2 (injection)','B3 Hydro','B4 Hydro','B5','B6','B7','B8', 'B9', 'B3 3C','B4 3C','B5 3C','B6 3C','B7 3C','B8 AE','B9 AE');

grid on;


% asbuilt = readtable('../AE_Monitoring/Hydro_Accel_xyz.csv');
% scatter3(asbuilt.X, asbuilt.Y, asbuilt.Z, 300, 'xm', 'LineWidth', 2);
