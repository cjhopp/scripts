...
temp_dir = '/projects/nesi00228/data/templates/nlloc_reloc/1_sec_5-2/*'
...
detect_list = []
detect_csv = '/projects/nesi00228/data/detections/2015_all_det_1sec.csv'
...
if split:
    ...
    instance_dates = [jul_days[i:i+split_size]
...
for day in inst_dats:
    ...
    new_cat = cat_util.detections_2_cat(day_dets, template_dict, st1, temp_prepick=0.1, max_lag=5,
                                        cc_thresh=0.3,
                                        write_wav='/projects/nesi00228/data/templates/2015_1sec_detections/',
                                        debug=1)
    new_cat.write('/projects/nesi00228/data/catalogs/2015_1sec_det_cats/2015_1sec_dets_%03d' % day, format='QUAKEML')