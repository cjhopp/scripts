"""
Taken from the mayavi Volume Slicer example:
 http://docs.enthought.com/mayavi/mayavi/auto/example_volume_slicer.html#example-volume-slicer

Modified slightly to accomodate matlab 3D grids from ZMAP
"""
...
def plot_grid(grid_dict, var='b'):
    """
    Umbrella function to plot a ZMAP 3d grid using Mayavi
    :param grid_dict: Dictionary of grid values as saved in matlab and
