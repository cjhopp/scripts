...
# plotTimes1 = []
# commonDetectors1 = []
# for folder in os.listdir('/Users/home/matsonga/seisan/REA/%s/2012' %cluster1):
...
plotTimes5.sort()
ax.plot(plotTimes5,values5,lw = 3.0,color = '#a6cee3',label='Multiplet 1')
#ax.set_zorder(2)
...
ax.legend(handles,labels,loc=0,fontsize=24)
#ax.grid()
ax.set_xlabel("Date",fontsize = 24)
ax.set_ylabel(r"Number of Detections",fontsize = 24)
ax2.set_ylabel(r"Injected Fluid(tonnes)",color = 'm', fontsize = 24)
