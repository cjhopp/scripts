...
def remove_HITP_spikes(
    ...
    if plot:
        ...
        savename_tf = os.path.join(plot_output_dir, f"fig_transfer_functions_{station}_{timestring}.jpg")
    ...
    if plot:
        ...
        if original_stream_for_plotting and original_stream_for_plotting[0].stats.npts / original_stream_for_plotting[0].stats.sampling_rate > wide_plot_start_offset_sec + wide_plot_duration_sec:
            ...
            savename_comp = os.path.join(plot_output_dir, f"fig_denoising_comparison_detailed_{station}_{timestring}.jpg")
